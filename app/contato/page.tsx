...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    const response = await fetch("https://backend-fornecedores.onrender.com/api/contato", {
      method: "POST",
  ...
  return (
    ...
    >
      ...
      <button
        onClick={toggleTheme}
        className="fixed bottom-8 right-8 w-15 h-15 bg-gradient-to-r from-orange-400 to-red-500 rounded-full flex items-center justify-center text-white shadow-lg shadow-cyan-400/25 transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-cyan-400/40 z-50"
        title="Alternar tema"
      >
            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4 transition-transform duration-300 hover:-translate-y-1">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-white/80">Recife-PE, 51.020-280</p>
                </div>
              </div>
            </div>
