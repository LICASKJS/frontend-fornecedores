...
import { Eye, EyeOff, Mail, Lock, Shield, Users, TrendingUp, ArrowRight, CheckCircle, Sun, Moon } from "lucide-react"
...
export default function LoginPage() {
  ...
  const getFocusClasses = () => {
    return isDarkMode
      ? "focus:border-cyan-400 focus:ring-cyan-400/10"
    ...
    >
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className={`absolute right-3 top-1/2 transform -translate-y-1/2 transition-colors duration-300 ${
                        isDarkMode ? "text-slate-400 hover:text-cyan-400" : "text-slate-500 hover:text-orange-500"
                      }`}
                    >
      ...
      <div
        className={`hidden lg:flex flex-1 relative overflow-hidden ${
          isDarkMode ? "bg-gradient-to-br from-cyan-400 to-emerald-500" : "bg-gradient-to-br from-orange-400 to-red-500"
        }`}
      >
