...
const handleSubmit = async (e) => {
  ...
  try {
    const response = await fetch('https://backend-fornecedores.onrender.com/api/cadastro', {
      method: 'POST',
      headers: {
    ...
    if (response.ok) {
      ...
      showToast(data.msg || "Erro no cadastro. Tente novamente.", "error");
    }
  } catch (error) {
    showToast("Erro de rede ou servidor.", "error");
  } finally {
  ...
  const getThemeColors = () => {
    if (isDarkMode) {
      return {
        ...
        button: "bg-gradient-to-r from-cyan-400 to-emerald-500",
        ...
        >
          <Link
            ...
            className={`absolute top-6 left-6 w-10 h-10 border rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 z-20 ${
              isDarkMode
                ? "bg-white/5 border-white/10 text-slate-300 hover:bg-gradient-to-r from-cyan-400 to-emerald-400 hover:text-white"
          ...
          <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-cyan-400/5 to-emerald-500/5 rounded-full blur-3xl opacity-30 animate-pulse"></div>
              ...
              <div className="animate-fade-in">
                <h1
                  className={`text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r ${
                    isDarkMode ? "from-cyan-400 to-emerald-500" : "from-orange-400 to-red-500"
                ...
                <div className="space-y-4 mb-8 text-left">
                  {[
                    ...
                    >
                      <item.icon className={`w-5 h-5 ${isDarkMode ? "text-cyan-400" : "text-orange-400"}`} />
              ...
              <div className="animate-fade-in">
                ...
                <div className="mb-8">
                  <div className={`flex items-center gap-3 p-4 rounded-lg ${colors.hover} justify-center`}>
                    <User className={`w-6 h-6 ${isDarkMode ? "text-cyan-400" : "text-orange-400"}`} />
          ...
          <div className="w-full max-w-md relative">
            ...
            >
                ...
                <div>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full h-12 pl-10 pr-4 border rounded-xl transition-all duration-300 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 ${colors.input} ${
                ...
                <div>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full h-12 pl-10 pr-12 border rounded-xl transition-all duration-300 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 ${colors.input} ${
                    ...
                    <div
                      className={`w-5 h-5 border-2 rounded transition-all duration-300 ${
                        loginData.rememberMe
                          ? `${isDarkMode ? "bg-cyan-400 border-cyan-400" : "bg-orange-400 border-orange-400"}`
                          : isDarkMode
                            ? "border-slate-400"
                            : "border-slate-300"
                      }`}
              ...
              <div className="text-center mt-6">
                <Link
                  href="/senha"
                  className={`${isDarkMode ? "text-cyan-400" : "text-orange-400"} hover:underline text-sm`}
                >
                  Esqueci minha senha
                </Link>
              </div>
            ...
            >
                ...
                <div>
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <span className={`text-sm leading-5 ${colors.accent}`}>
                      Aceito os{" "}
                      <a href="#" className={`${isDarkMode ? "text-cyan-400" : "text-orange-400"} hover:underline`}>
                        termos de uso
                      </a>{" "}
                      e{" "}
                      <a href="#" className={`${isDarkMode ? "text-cyan-400" : "text-orange-400"} hover:underline`}>
              ...
              <div className="text-center mt-6">
                <button
                  onClick={() => switchToMode(true)}
                  disabled={isTransitioning}
                  className={`flex items-center gap-2 ${isDarkMode ? "text-cyan-400" : "text-orange-400"} hover:underline text-sm mx-auto disabled:opacity-50`}
                >
